export const en = {
  ...
  'template.uShape': 'U-shape',
  'ui.duplicateProject': 'Duplicate',
  'ui.deleteProject': 'Delete',
  'ui.confirmDelete': 'Delete "{name}"? This cannot be undone.',
  'ui.copySuffix': '{name} (copy)',
  'ui.justNow': 'just now',
  'ui.minutesAgo': '{n} min ago',
  'ui.hoursAgo': '{n} h ago',
  'ui.daysAgo': '{n} d ago',
  'ui.settingsSummary': 'Room & settings',
  ...
  // pdf
  'pdf.scale': 'Scale 1:{n}',
  'pdf.defaultTitle': 'Walk-in Planner',
  'pdf.date': 'Date',
  'pdf.room': 'Room W × D × H',
  'pdf.door': 'Door',
  ...
  'error.shoePitch': '{wall}, unit {unit}: shoe shelves need at least {n} mm each',
  ...
  'toast.storageFull': 'Could not save: browser storage is full — export the project to a file',
  'toast.projectMissing': 'That project is no longer stored — removed from the list',
  'toast.linkCopied': 'Link copied — anyone with it opens a copy of this design',
  'toast.shareInvalid': 'That link does not carry a readable design',
  'toast.sharedImported': 'Opened the shared design as a new project',
  'toast.shareFailed': 'Could not build the link: {error}',
} as const;
