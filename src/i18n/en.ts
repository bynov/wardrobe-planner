export const en = {
  ...
  // corners (keyed by the anchor wall: back = back-left, right = back-right, ...)
  'corner.back': 'Back-left corner',
  'corner.right': 'Back-right corner',
  'corner.front': 'Front-right corner',
  'corner.left': 'Front-left corner',
  'corner.tag.back': 'BL',
  'corner.tag.right': 'BR',
  'corner.tag.front': 'FR',
  'corner.tag.left': 'FL',
  'corner.mode.none': 'None (runs meet)',
  'corner.mode.lshelf': 'L-shaped shelves',
  'ui.cornerMode': 'Corner',
  'ui.cornerWidth': 'Leg length, mm',
  'ui.cornerShelves': 'Compartments',
  'ui.cornerHint': 'Both runs stop short of the corner by the leg length.',
  'ui.cornerRange': 'Leg length: {min}–{max} mm',
  'ui.cornerInactive': 'Both walls need wardrobe before this corner is built.',
  ...
  'ui.rail': 'Rail',
  'ui.rodFrom.top': 'from top',
  'ui.rodFrom.bottom': 'from bottom',
  'ui.railHeight': 'rail at {n} mm AFF',
  'zone.open': 'Open',
  ...
  'pdf.cornerSummary': '{mode}, leg {w} mm, {n} shelves',
  ...
  'error.cornerWidth': '{corner}: leg length must be between {min} and {max} mm',
  'error.cornerShelves': '{corner}: a corner needs at least 1 compartment',
